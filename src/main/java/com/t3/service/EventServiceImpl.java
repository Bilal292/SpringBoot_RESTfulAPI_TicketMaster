...
public class EventServiceImpl implements EventService {
    ...
    public List<Event> getUpcomingEvents(User user) {
        ...
        // Format the query parameters for the API request, including sorting by date,
        // setting the start and end date times, and setting the country code to GB (Great Britain)
        ...
        // Make a GET request to the API and store the response as a String
    ...
    private List<UserHistory> extractEventDetailsHistory(String jsonResponse) {
        ...
        try {
            ...
            // Navigate to the array of events within the JSON structure
            JsonNode eventsArray = root.path("_embedded").path("events");

            // Iterate over each event node in the array
            for (JsonNode eventNode : eventsArray) {
                ...
                // Create a new UserHistory object and set its properties
